...
def show(li, path):
  ...
  c = np.array([0.9,0.8,0.7,0.8,0.9,0.7,0.9,0.6,0.9,0.8], dtype=np.float32)
...
@app.route("/Leprosy_Detector",methods=['GET', 'POST'])
def index():
 if request.method == 'POST':
  ...
  if file and check_allowed_file(file.filename):
   ...
   cc = '/home/LepDetect/Leprosy-detection-using-ML/detect_float.tflite'
   dd = '/home/LepDetect/Leprosy-detection-using-ML/model.tflite'
   cimg = show(*run( rimg, cc), rimg)
